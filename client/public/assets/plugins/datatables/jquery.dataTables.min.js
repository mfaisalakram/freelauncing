...
(function (Ea, Q, k) {
  var P = function (h) {
        ...
        b = h('<div/>')
          ...
          .append(
            h('<div/>')
              ...
              .append(
                h('<div className="test"/>').css({ width: '100%', height: 10 })
              )
          )
          .appendTo('body'),
        c = b.find('.test');
    ...
    function ka(a, b, c) {
      ...
      !b.bSortable || (!a && !c)
        ? ((b.sSortingclassName = e.sSortableNone), (b.sSortingClassJUI = ''))
        : a && !c
        ? ((b.sSortingclassName = e.sSortableAsc),
          (b.sSortingClassJUI = e.sSortJUIAscAllowed))
        : !a && c
        ? ((b.sSortingclassName = e.sSortableDesc),
          (b.sSortingClassJUI = e.sSortJUIDescAllowed))
        : ((b.sSortingclassName = e.sSortable),
            ...
            (g = o[j]),
              ...
              g && g._bAttrSrc
                ? (S(g.mData._)(e, i),
                  ...
                  q(g.mData.filter, a))
                : l
                ? (g._setter || (g._setter = S(g.mData)), g._setter(e, i))
                : (e[j] = i);
          j++;
        };
      if (f)
    ...
    function Ja(a, b, c, e) {
      ...
      if (null === d.nTr) {
        ...
        for (q = a.aoColumns.length; l < q; l++) {
          ...
          h.fnCreatedCell &&
            h.fnCreatedCell.call(a.oInstance, i, x(a, b, l), f, b, l);
        }
