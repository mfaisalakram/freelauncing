        ...
        : ((this.handle = this._getHandle(t)),
          this.handle
            ? (e(i.iframeFix === !0 ? 'iframe' : i.iframeFix).each(function () {
                e(
                  "<div className='ui-draggable-iframeFix' style='background: #fff;'></div>"
                )
                  .css({
    ...
    _create: function () {
      ...
      if (
        ...
        for (
          ...
          (s = e.trim(t[i])),
            (a = 'ui-resizable-' + s),
            (n = e("<div className='ui-resizable-handle " + a + "'></div>")),
  ...
  e.widget('ui.selectable', e.ui.mouse, {
    ...
    _create: function () {
      ...
      this.element.addClass('ui-selectable'),
        ...
        this._mouseInit(),
        (this.helper = e("<div className='ui-selectable-helper'></div>"));
    },
    _destroy: function () {
    ...
    _resetButton: function () {
      ...
      s.primary || s.secondary
        ? (this.options.text &&
          ...
          s.primary &&
            e.prepend(
              "<span className='ui-button-icon-primary ui-icon " +
                s.primary +
                "'></span>"
            ),
          s.secondary &&
            e.append(
              "<span className='ui-button-icon-secondary ui-icon " +
                s.secondary +
                "'></span>"
            ),
          this.options.text ||
    ...
    (this._curInst = null),
      ...
      (this.dpDiv = s(
        t(
          "<div id='" +
            this._mainDivId +
            "' className='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"
        )
      ));
  }
  function s(e) {
  ...
  t.extend(i.prototype, {
    ...
    _attachments: function (e, i) {
      ...
      i.append && i.append.remove(),
        r &&
          ((i.append = t(
            "<span className='" + this._appendClass + "'>" + r + '</span>'
          )),
      ...
      for (
        t.drawMonth = Z,
          ...
          s = this._canAdjustMonth(t, -1, te, Z)
            ? "<a className='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" +
              i +
              "'><span className='ui-icon ui-icon-circle-triangle-" +
              (Y ? 'e' : 'w') +
              "'>" +
              i +
              '</span></a>'
            : J
            ? ''
            : "<a className='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" +
              i +
              "'><span className='ui-icon ui-icon-circle-triangle-" +
              (Y ? 'e' : 'w') +
              "'>" +
          ...
          a = this._canAdjustMonth(t, 1, te, Z)
            ? "<a className='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" +
              n +
              "'><span className='ui-icon ui-icon-circle-triangle-" +
              (Y ? 'w' : 'e') +
              "'>" +
            ...
            : J
            ? ''
            : "<a className='ui-datepicker-next ui-corner-all ui-state-disabled' title='" +
              n +
              "'><span className='ui-icon ui-icon-circle-triangle-" +
              (Y ? 'w' : 'e') +
              "'>" +
          ...
          h = t.inline
            ? ''
            : "<button type='button' className='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" +
          ...
          l = B
            ? "<div className='ui-datepicker-buttonpane ui-widget-content'>" +
              (Y ? h : '') +
              (this._isInRange(t, o)
                ? "<button type='button' className='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" +
                  r +
                  '</button>'
                : '') +
              (Y ? '' : h) +
        ...
        for (w = '', this.maxRows = 4, D = 0; Q[1] > D; D++) {
          if (
            ...
            if (((M += "<div className='ui-datepicker-group"), Q[1] > 1))
              switch (D) {
                case 0:
          ...
          for (
            M +=
              "<div className='ui-datepicker-header ui-widget-header ui-helper-clearfix" +
              C +
              "'>" +
              ...
              '<tr>',
              S = u
                ? "<th className='ui-datepicker-week-col'>" +
          ...
          for (
            ...
            for (
              M += '<tr>',
                F = u
                  ? "<td className='ui-datepicker-week-col'>" +
    ...
    _generateMonthYearHeader: function (t, e, i, s, n, a, r, o) {
      var h,
        ...
        y = '';
      if (a || !g)
        y += "<span className='ui-datepicker-month'>" + r[e] + '</span>';
      else {
        for (
          h = s && s.getFullYear() === i,
            l = n && n.getFullYear() === i,
            y +=
              "<select className='ui-datepicker-month' data-handler='selectMonth' data-event='change'>",
            c = 0;
          12 > c;
          c++
        )
      ...
      if ((_ || (b += y + (!a && g && v ? '' : '&#xa0;')), !t.yearshtml))
        if (((t.yearshtml = ''), a || !v))
          b += "<span className='ui-datepicker-year'>" + i + '</span>';
        else {
          for (
            u = this._get(t, 'yearRange').split(':'),
              ...
              t.yearshtml +=
                "<select className='ui-datepicker-year' data-handler='selectYear' data-event='change'>";
            m >= f;
            f++
          )
            t.yearshtml +=
  ...
  t.widget('ui.progressbar', {
    ...
    _create: function () {
      (this.oldValue = this.options.value = this._constrainedValue()),
        ...
        (this.valueDiv = t(
          "<div className='ui-progressbar-value ui-widget-header ui-corner-left'></div>"
      ...
      this.valueDiv
        ...
        this.indeterminate
          ? (this.element.removeAttr('aria-valuenow'),
            this.overlayDiv ||
              (this.overlayDiv = t(
                "<div className='ui-progressbar-overlay'></div>"
...
(function (t) {
  ...
  t.widget('ui.spinner', {
    ...
    _buttonHtml: function () {
      return (
        "<a className='ui-spinner-button ui-spinner-up ui-corner-tr'><span className='ui-icon " +
        this.options.icons.up +
        "'>&#9650;</span>" +
        '</a>' +
        "<a className='ui-spinner-button ui-spinner-down ui-corner-br'>" +
      ...
      if (n) {
        ...
        s.is('[title]') &&
          ...
          this.options.track && i && /^mouse/.test(i.type)
            ...
            : o.position(t.extend({ of: s }, this.options.position)),
          o.hide(),
  ...
  (t.effects = { effect: {} }),
    ...
    (function () {
      ...
      t.each(
        ...
        (t.effects.animateclassName = function (e, a, o, r) {
          var h = t.speed(a, o, r);
...
(function (t) {
  t.effects.effect.transfer = function (e, i) {
    var s = t(this),
      ...
      u = s.offset(),
      d = t("<div className='ui-effects-transfer'></div>")
