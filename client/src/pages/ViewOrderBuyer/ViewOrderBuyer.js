...
import ModifyOrderBuyerReceive from '../../components/OrderComponent/ModifyOrder/ModifyOrderBuyerReceive/ModifyOrderBuyerReceive';
import DeliveryTemplateBuyerReceive from '../../components/OrderComponent/DeliveryTemplateBuyerReceive/DeliveryTemplateBuyerReceive';
import ModifyOrdeBuyerSend from '../../components/OrderComponent/ModifyOrder/ModifyOrdeBuyerSend/ModifyOrdeBuyerSend';
import ExtendDeliveryTimeBuyerSend from '../../components/OrderComponent/ExtendDelivery/ExtendDeliveryTimeBuyerSend/ExtendDeliveryTimeBuyerSend';
import ExtendDeliverTimeBuyerReceive from '../../components/OrderComponent/ExtendDelivery/ExtendDeliverTimeBuyerReceive/ExtendDeliverTimeBuyerReceive';
import CancelOrderBuyerReceive from '../../components/OrderComponent/CancelOrder/CancelOrderBuyerReceive/CancelOrderBuyerReceive';
import CancelOrderSellerSend from '../../components/OrderComponent/CancelOrder/CancelOrderSellerSend/CancelOrderSellerSend';
import CancelOrdeReceiveSend from '../../components/OrderComponent/CancelOrder/CancelOrdeBuyerSend/CancelOrdeBuyerSend';
import CancelOrdeBuyerSend from '../../components/OrderComponent/CancelOrder/CancelOrdeBuyerSend/CancelOrdeBuyerSend';

const ViewOrderBuyer = (props) => {
  ...
  const getorderData = async () => {
    ...
    await axios
      .get(props.baseUrl + '/api/orders/buyer/order-by-id/' + orderID)
      .then((response) => {
  ...
  const declineDelivery = (id) => {
    ...
    axios
      .post('/api/orders/decline-order-delivery/', data, config)
      .then((res) => {
        props.setToast([
          {
            msg: 'you decline the delivery of order ' + orderID,
            type: 'success',
          },
        ]);
  ...
  const acceptDelivery = (id) => {
    ...
    axios
      .post('/api/orders/accept-order-delivery/', data, config)
      .then((res) => {
        props.setToast([
          {
            msg: 'you accepted the delivery of order ' + orderID,
            type: 'success',
          },
        ]);
                  ...
                  <div className="row">
                    <div className="col-md-9">
                      ...
                      <p>
                        ...
                        <Link
                          className="username"
                          to={'/users/' + orderData.seller_username}
                        >
                          {orderData.seller_username}
                        </Link>{' '}
                    ...
                    <OrderStep
                      ...
                      description={
                        <div>
                          ...
                          <br />
                          <span>provide requried documents for better</span>
                        </div>
                      }
                    />
                      ...
                      <div className="col-sm-12">
                        <div className="delivery-box">
                          <p>
                            ...
                            <strong>{orderData.seller_username}</strong>
                          </p>
                        </div>
                      </div>
