...
(function ($) {
  ...
  $(function () {
    ...
    $('.cui__menuTop__backdrop, .cui__menuTop__mobileTrigger').on(
      'click',
      function () {
    ...
    $('.cui__menuTop__submenu > .cui__menuTop__item__link').on(
      'click',
      function () {
    ...
    // /////////////////////////////////////////////////////////////////////////////////////////
    // // add backdrop
    // $('.cui-menu-top').after('<div className="cui-menu-top-backdrop"><!-- --></div>')
    // /////////////////////////////////////////////////////////////////////////////////////////
    // // menu logic
