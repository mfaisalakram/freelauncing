 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/fc-3.2.5/r-2.2.2
 *
 * Included libraries:
...
(function (h) {
  ...
  function ka(a, b, c) {
    ...
    c !== k &&
      ...
      c.className && !c.sClass && (c.sclassName = c.className),
    ...
    !b.bSortable || (!a && !c)
      ? ((b.sSortingclassName = d.sSortableNone), (b.sSortingClassJUI = ''))
      : a && !c
      ? ((b.sSortingclassName = d.sSortableAsc),
        (b.sSortingClassJUI = d.sSortJUIAscAllowed))
      : !a && c
      ? ((b.sSortingclassName = d.sSortableDesc),
        (b.sSortingClassJUI = d.sSortJUIDescAllowed))
      : ((b.sSortingclassName = d.sSortable),
  ...
  function la(a) {
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k)
      ...
      u &&
        I(function (a, b) {
          a.innerHTML = '<div className="dataTables_sizing">' + A[b] + '</div>';
          a.childNodes[0].style.height = '0';
          a.childNodes[0].style.overflow = 'hidden';
          a.style.width = y[b];
        }, R);
  ...
  n.ext = x = {
    buttons: {},
    classes: {},
    builder: 'bs4/dt-1.10.18/fc-3.2.5/r-2.2.2',
    errMode: 'alert',
    feature: [],
    search: [],
...
(function (b) {
  ...
  f.ext.renderer.pageButton.bootstrap = function (a, h, r, s, j, n) {
    ...
    q(b(h).empty().html('<ul className="pagination"/>').children('ul'), s);
    i !== m &&
      b(h)
        .find('[data-dt-idx=' + i + ']')
        .focus();
...
(function (d) {
  ...
  d.extend(m.prototype, {
    ...
    _fnGridSetup: function () {
      ...
      var c = d(
          '<div className="DTFC_ScrollWrapper" style="position:relative; clear:both;"><div className="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;" aria-hidden="true"><div className="DTFC_LeftHeadWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div className="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"><div className="DTFC_LeftBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll;"></div></div><div className="DTFC_LeftFootWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div></div><div className="DTFC_RightWrapper" style="position:absolute; top:0; right:0;" aria-hidden="true"><div className="DTFC_RightHeadWrapper" style="position:relative; top:0; left:0;"><div className="DTFC_RightHeadBlocker DTFC_Blocker" style="position:absolute; top:0; bottom:0;"></div></div><div className="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"><div className="DTFC_RightBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll;"></div></div><div className="DTFC_RightFootWrapper" style="position:relative; top:0; left:0;"><div className="DTFC_RightFootBlocker DTFC_Blocker" style="position:absolute; top:0; bottom:0;"></div></div></div></div>'
        )[0],
        e = c.childNodes[0],
        f = c.childNodes[1];
...
(function (c) {
  'function' === typeof define && define.amd
    ? define(
        ['jquery', 'datatables.net-bs4', 'datatables.net-fixedcolumns'],
        function (a) {
      ...
      return function (b, c, e) {
        if (c) d('div.dtr-modal-content').empty().append(e());
          ...
          var f = function () {
            ...
            g = d('<div className="dtr-modal"/>')
              .append(
                d('<div className="dtr-modal-display"/>')
                  .append(d('<div className="dtr-modal-content"/>').append(e()))
                  .append(
                    d('<div className="dtr-modal-close">&times;</div>').click(
                      function () {
                        f();
                      }
                    )
              ...
              .append(
                d('<div className="dtr-modal-background"/>').click(function () {
                  f();
                })
              )
              .appendTo('body');
        ...
        d.each(c, function (b, c) {
          c.hidden &&
            (d(
              ...
              .append(
                d('<span className="dtr-data"/>').append(
    ...
    listHidden: function () {
      return function (a, b, c) {
        return (a = d
          ...
          .join(''))
          ? d(
              '<ul data-dtr-index="' + b + '" className="dtr-details"/>'
            ).append(a)
          : !1;
      };
    },
    tableAll: function (a) {
      ...
      return function (b, c, e) {
        b = d
          ...
          .join('');
        return d(
          '<table className="' + a.tableClass + ' dtr-details" width="100%"/>'
        ).append(b);
      };
    },
  };
      ...
      if (c.fn.modal) {
        if (!d) {
          if (a && a.header) {
            ...
            d.empty()
              .append('<h4 className="modal-title">' + a.header(b) + '</h4>')
              .append(h);
          }
