...
(function (a, b) {
    ...
    wa = b(function (a) {
      ...
      L('inspectSource', function (a) {
        ...
        (a.exports = function (a, b, e, f) {
          ...
          return (
            ('function' === typeof this && b(this).source) || ia.call(this)
          );
        });
    }),
    xa = function (a, b) {
  ...
  var Ob = {
      html: {
        inputGroups: {
          3: [
            '<span tabindex="100" className="add-on input-group-addon %s" title="%s">',
            '</span>',
          ],
          4: [
            '<div className="%s"><button tabindex="100" title="%s" className="btn btn-outline-secondary" type="button">',
            '</button></div>',
          ],
        }[Mb],
      },
        ...
        g(b, [
          {
            ...
            value: function () {
              ...
              'before' === this.options.placement
                ...
                this.$element.wrap(
                  '<div className="input-group'.concat(
