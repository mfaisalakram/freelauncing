...
!(function (t, e) {
  ...
  (x.prototype.init = function () {
    ...
    (x.prototype.getXAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
        d = {
    ...
    (x.prototype.updateXAxisTickValues = function (t, e) {
      var i,
        n = this.owner,
        r = n.config;
      return (
    ...
    (x.prototype.getYAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
    ...
    (x.prototype.getId = function (t) {
      var e = this.owner.config;
      return t in e.data_axes ? e.data_axes[t] : 'y';
    }),
    (x.prototype.getXAxisTickFormat = function () {
      var e = this.owner,
        i = e.config,
        n = e.isTimeSeries()
    ...
    (x.prototype.getTickValues = function (t, e) {
      return t || (e ? e.tickValues() : void 0);
    }),
    (x.prototype.getXAxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_x_tick_values,
        this.owner.xAxis
      );
    }),
    (x.prototype.getYAxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_y_tick_values,
        this.owner.yAxis
      );
    }),
    (x.prototype.getY2AxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_y2_tick_values,
        this.owner.y2Axis
      );
    }),
    (x.prototype.getLabelOptionByAxisId = function (t) {
      var e,
        i = this.owner.config;
      return (
        'y' === t
    ...
    (x.prototype.getLabelText = function (t) {
      var e = this.getLabelOptionByAxisId(t);
      return f(e) ? e : e ? e.text : null;
    }),
    (x.prototype.setLabelText = function (t, e) {
    ...
    (x.prototype.getLabelPosition = function (t, e) {
    ...
    (x.prototype.getXAxisLabelPosition = function () {
      return this.getLabelPosition(
        'x',
        this.owner.config.axis_rotated ? 'inner-top' : 'inner-right'
      );
    }),
    (x.prototype.getYAxisLabelPosition = function () {
      return this.getLabelPosition(
        'y',
        this.owner.config.axis_rotated ? 'inner-right' : 'inner-top'
      );
    }),
    (x.prototype.getY2AxisLabelPosition = function () {
      return this.getLabelPosition(
        'y2',
        this.owner.config.axis_rotated ? 'inner-right' : 'inner-top'
      );
    }),
    (x.prototype.getLabelPositionById = function (t) {
      return 'y2' === t
    ...
    (x.prototype.textForXAxisLabel = function () {
      return this.getLabelText('x');
    }),
    (x.prototype.textForYAxisLabel = function () {
      return this.getLabelText('y');
    }),
    (x.prototype.textForY2AxisLabel = function () {
      return this.getLabelText('y2');
    }),
    (x.prototype.xForAxisLabel = function (t, e) {
      var i = this.owner;
      return t
        ? e.isLeft
          ? 0
    ...
    (x.prototype.dxForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? '0.5em'
          : e.isRight
    ...
    (x.prototype.textAnchorForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? 'start'
          : e.isCenter
    ...
    (x.prototype.xForXAxisLabel = function () {
      return this.xForAxisLabel(
        !this.owner.config.axis_rotated,
        this.getXAxisLabelPosition()
      );
    }),
    (x.prototype.xForYAxisLabel = function () {
      return this.xForAxisLabel(
        this.owner.config.axis_rotated,
        this.getYAxisLabelPosition()
      );
    }),
    (x.prototype.xForY2AxisLabel = function () {
      return this.xForAxisLabel(
        this.owner.config.axis_rotated,
        this.getY2AxisLabelPosition()
      );
    }),
    (x.prototype.dxForXAxisLabel = function () {
      return this.dxForAxisLabel(
        !this.owner.config.axis_rotated,
        this.getXAxisLabelPosition()
      );
    }),
    (x.prototype.dxForYAxisLabel = function () {
      return this.dxForAxisLabel(
        this.owner.config.axis_rotated,
        this.getYAxisLabelPosition()
      );
    }),
    (x.prototype.dxForY2AxisLabel = function () {
      return this.dxForAxisLabel(
        this.owner.config.axis_rotated,
        this.getY2AxisLabelPosition()
      );
    }),
    (x.prototype.dyForXAxisLabel = function () {
      var t = this.owner,
        e = t.config,
    ...
    (x.prototype.dyForYAxisLabel = function () {
      var t = this.owner,
    ...
    (x.prototype.dyForY2AxisLabel = function () {
      var t = this.owner,
    ...
    (x.prototype.textAnchorForXAxisLabel = function () {
      var t = this.owner;
    ...
    (x.prototype.textAnchorForYAxisLabel = function () {
      var t = this.owner;
      return this.textAnchorForAxisLabel(
        t.config.axis_rotated,
        this.getYAxisLabelPosition()
    ...
    (x.prototype.textAnchorForY2AxisLabel = function () {
      var t = this.owner;
      return this.textAnchorForAxisLabel(
        t.config.axis_rotated,
        this.getY2AxisLabelPosition()
    ...
    (x.prototype.getMaxTickWidth = function (t, e) {
      var i,
        n,
        r,
        a,
    ...
    (x.prototype.updateLabels = function (t) {
      var e = this.owner,
    ...
    (x.prototype.getPadding = function (t, e, i, n) {
    ...
    (x.prototype.convertPixelsToAxisPadding = function (t, e) {
      var i = this.owner;
      return e * (t / (i.config.axis_rotated ? i.width : i.height));
    }),
    (x.prototype.generateTickValues = function (t, e, i) {
      var n,
        r,
        a,
        o,
    ...
    (x.prototype.generateTransitions = function (t) {
    ...
    (x.prototype.redraw = function (t, e) {
      var i = this.owner,
  ...
  var t = {
    ...
    chart: {
      ...
      internal: {
        fn: l.prototype,
        axis: { fn: x.prototype, internal: { fn: e.prototype } },
      },
    },
    generate: function (t) {
      return new n(t);
  ...
  (l.prototype.beforeInit = function () {}),
      ...
      if (
        ...
        if (D.axis_x_tick_culling && C) {
          ...
          I.svg
            ...
            .style('display', 'block');
      (f = I.generateDrawArea ? I.generateDrawArea(F, !1) : void 0),
        (_ = I.generateDrawBar ? I.generateDrawBar(X) : void 0),
        (x = I.generateDrawLine ? I.generateDrawLine(z, !1) : void 0),
        (y = I.generateXYForText(F, X, z, !0)),
        (m = I.generateXYForText(F, X, z, !1)),
        I.updateCircleY(),
        ...
        D.subchart_show &&
          I.redrawSubchart &&
          I.redrawSubchart(n, e, S, w, F, X, z),
        ...
        S && I.isTabVisible()
          ? ((P = k.transition().duration(S)),
            ...
            T(function () {
              A && A(), D.onrendered && D.onrendered.call(I);
            }))
          : (I.redrawBar(_),
            I.redrawLine(x),
            I.redrawArea(f),
    ...
    (l.prototype.updateSvgSize = function () {
      var t = this,
        e = t.svg.select('.'.concat(Y.brush, ' .overlay'));
    ...
    (n.prototype.show = function (t, e) {
      ...
      (t = n.mapToTargetIds(t)),
        ...
        (i = n.svg.selectAll(n.selectorTargets(t)))
          .transition()
          .style('display', g() ? 'block' : 'initial', 'important')
    ...
    (n.prototype.subchart.hide = function () {
      ...
      t.config.subchart_show &&
        ((t.config.subchart_show = !1), t.removeSubchart(), t.redraw());
    }),
          ...
          1 === l.filterTargetsToShow(l.data.targets).length
            ...
            : o
                .style('fill', function (t) {
                  return l.levelColor
                    ? l.levelColor(
                        t.data.values.reduce(function (t, e) {
                          return t + e.value;
                        }, 0)
                      )
                    : l.color(t.data);
    ...
    (l.prototype.generateTargetclassName = function (t) {
      return t || 0 === t ? ('-' + t).replace(/\s/g, '-') : '';
    }),
    (l.prototype.generateclassName = function (t, e) {
    ...
    (l.prototype.getClipPath = function (t) {
      return 'url(' + (g(9) ? '' : document.URL.split('#')[0]) + '#' + t + ')';
    }),
    ...
    (l.prototype.convertDataToTargets = function (t, n) {
      var e,
        ...
        u = l.config;
      if (
        (c(t) ? (a = Object.keys(t[0])) : ((a = t.keys), (t = t.rows)),
        (r = a.filter(l.isX, l)),
    ...
    (l.prototype.dataLabelFormat = function (t) {
      ...
      return 'function' === typeof i.format
        ? i.format
        : 'object' === s(i.format)
        ? i.format[t]
          ? !0 === i.format[t]
            ...
            return (
              [].concat(t).forEach(function (t) {
                (('value' in t && e.value === t.value) ||
                  ('class' in t && e.className === t.class)) &&
                  (i = !0);
              }),
              i
            );
    ...
    (l.prototype.removeGridLines = function (t, e) {
      ...
      this.main
        ...
        .remove(),
        e
          ? (n.grid_x_lines = n.grid_x_lines.filter(i))
          : (n.grid_y_lines = n.grid_y_lines.filter(i));
    }),
        ...
        (h ? x.transition() : x)
          .style(
            ...
            m.levelColor
              ? function (t) {
                  return m.levelColor(
                    m.cache[t].values.reduce(function (t, e) {
                      return t + e.value;
                    }, 0)
                  );
                }
    ...
    (l.prototype.isWithinBar = function (t, e) {
      return (function (t, e, i) {
        var n = 2 < arguments.length && void 0 !== i ? i : 0,
          ...
          o = e.y + e.height + n,
          s = e.y - n;
        return r < t[0] && t[0] < a && s < t[1] && t[1] < o;
      })(t, p(e), 2);
    }),
    ...
    (l.prototype.generateDrawLine = function (t, o) {
      ...
      return (
        (d = c.axis_rotated ? d.x(i).y(e) : d.x(e).y(i)),
        c.line_connectNull ||
    ...
    (l.prototype.lineWithRegions = function (t, c, d, e) {
      ...
      function S(t, e) {
        ...
        for (i = 0; i < e.length; i++)
          if (e[i].start < t && t <= e[i].end) return 1;
      }
      if (k(e))
        for (i = 0; i < e.length; i++)
          (m[i] = {}),
    ...
    (l.prototype.generateDrawArea = function (t, e) {
      ...
      function n(t, e) {
        return 0 < o.data_groups.length
          ? c(t, e)[0][1]
          : d.call(a, t.id)(a.getAreaBaseValue(t.id));
      }
      function r(t, e) {
        return 0 < o.data_groups.length
          ? c(t, e)[1][1]
          : d.call(a, t.id)(t.value);
      }
      var a = this,
        o = a.config,
        s = a.d3.area(),
      ...
      return (
        ...
        function (t) {
          ...
          return (
            (a.isAreaType(t)
              ? (a.isStepType(t) && (e = a.convertValuesToStep(e)),
                s.curve(a.getInterpolate(t))(e))
              : (e[0] &&
                  ((i = a.x(e[0].x)), (n = a.getYScale(t.id)(e[0].value))),
    ...
    (l.prototype.drawColorScale = function () {
      var t,
        ...
        l = s.data.targets[0];
      if (
        ((t = isNaN(d.stanford_scaleWidth) ? 20 : d.stanford_scaleWidth), t < 0)
      )
        throw Error(
    ...
    (l.prototype.xForColorScale = function () {
      return (
        this.config.stanford_padding.right + p(this.colorScale.node()).width
      );
    }),
    ...
    (l.prototype.getStanfordTooltipTitle = function (t) {
      ...
      return '\n      <tr><th>'
        .concat(e ? _(e) : 'x', "</th><th className='value'>")
        .concat(t.x, '</th></tr>\n      <tr><th>')
        .concat(i ? _(i) : 'y', "</th><th className='value'>")
      ...
      return (
        ...
        }, 0)),
        {
          value: (e = n.values.reduce(function (t, e) {
            return b(e, i) ? t + Number(e.epochs) : t;
          }, 0)),
  ...
  return (
    ...
    (l.prototype.getTooltipSortFunction = function () {
      ...
      if (f(n) && 'asc' === n.toLowerCase())
        return function (t, e) {
          return r(t) - r(e);
        };
      if (f(n) && 'desc' === n.toLowerCase())
        return function (t, e) {
          return r(e) - r(t);
        };
      if (h(n)) {
        ...
        if (t[a] && (t[a].value || 0 === t[a].value)) {
          if (l.isStanfordGraphType())
            r ||
              ...
              (r = "<table className='" + l.CLASS.tooltip + "'>" + o)),
          ...
          void 0 !== s &&
            ((r +=
              ...
              "'>"),
            (r +=
              "<td className='name'><span style='background-color:" +
              d +
              "'></span>" +
              c +
              '</td>'),
            (r += "<td className='value'>" + s + '</td>'),
            (r += '</tr>'));
        }
      return r + '</table>';
    }),
