  ...
  function i(i, t) {
    if (window.File && window.FileReader && window.FileList && window.Blob) {
      var s = {
        ...
        tpl: {
          wrap: '<div className="dropify-wrapper"></div>',
          loader: '<div className="dropify-loader"></div>',
          message:
            '<div className="dropify-message"><span className="file-icon" /> <p>{{ default }}</p></div>',
          preview:
            '<div className="dropify-preview"><span className="dropify-render"></span><div className="dropify-infos"><div className="dropify-infos-inner"><p className="dropify-infos-message">{{ replace }}</p></div></div></div>',
          filename:
            '<p className="dropify-filename"><span className="file-icon"></span> <span className="dropify-filename-inner"></span></p>',
          clearButton:
            '<button type="button" className="dropify-clear">{{ remove }}</button>',
          errorLine: '<p className="dropify-error">{{ error }}</p>',
          errorsContainer:
    ...
    (i.prototype.setPreview = function (i, t) {
      ...
      if ((this.hideLoader(), i === !0)) {
        ...
        e('<i />').attr('class', 'dropify-font-file').appendTo(s),
          e('<span className="dropify-extension" />')
