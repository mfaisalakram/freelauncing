...
!(function (i) {
  ...
  (h.prototype = {
    ...
    append: function () {
      ...
      this.$cache.input.before(t),
        ...
        this.$cache.cont.html(
          '<span className="irs"><span className="irs-line" tabindex="0"></span><span className="irs-min">0</span><span className="irs-max">1</span><span className="irs-from">0</span><span className="irs-to">0</span><span className="irs-single">0</span></span><span className="irs-grid"></span>'
        ),
        ...
        'single' === this.options.type
          ? (this.$cache.cont.append(
              '<span className="irs-bar irs-bar--single"></span><span className="irs-shadow shadow-single"></span><span className="irs-handle single"><i></i><i></i><i></i></span>'
            ),
          ...
          : (this.$cache.cont.append(
              '<span className="irs-bar"></span><span className="irs-shadow shadow-from"></span><span className="irs-shadow shadow-to"></span><span className="irs-handle from"><i></i><i></i><i></i></span><span className="irs-handle to"><i></i><i></i><i></i></span>'
            ),
            (this.$cache.bar = this.$cache.cont.find('.irs-bar')),
    ...
    appendDisableMask: function () {
      this.$cache.cont.append('<span className="irs-disable-mask"></span>'),
      ...
      if (this.options.grid) {
        ...
        for (
          ...
          for (
            ...
            _ +=
              '<span className="irs-grid-pol small" style="left: ' +
              this.toFixed(c - e * i) +
              '%"></span>';
          (_ +=
            '<span className="irs-grid-pol" style="left: ' + c + '%"></span>'),
            (h = this.convertToValue(c)),
            (_ +=
              '<span className="irs-grid-text js-grid-text-' +
              t +
              '" style="left: ' +
              c +
              '%">' +
