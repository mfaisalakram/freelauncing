...
(function (t, e) {
  ...
  function e(t) {
    ...
    t.querySelector('.ladda-label') ||
      (t.innerHTML =
        '<span className="ladda-label">' + t.innerHTML + '</span>');
    var e,
      n = t.querySelector('.ladda-spinner');
    n ||
      ((n = document.createElement('span')), (n.className = 'ladda-spinner')),
      t.appendChild(n);
    var r,
      a = {
        start: function () {
  ...
  function r(t) {
    for (
      var e = ['input', 'textarea', 'select'], n = [], r = 0;
      e.length > r;
      r++
    )
            ...
            function () {
              ...
              if (i !== void 0)
                for (var o = r(i), d = 0; o.length > d; d++)
                  '' === o[d].value.replace(/^\s+|\s+$/g, '') && (e = !1),
                    ('checkbox' !== o[d].type && 'radio' !== o[d].type) ||
                      o[d].checked ||
                      (e = !1),
                    'email' === o[d].type &&
                      (e =
              ...
              e &&
                ...
                'number' === typeof a.timeout &&
                  (clearTimeout(u), (u = setTimeout(s.stop, a.timeout))),
                'function' === typeof a.callback &&
                  a.callback.apply(null, [s]));
            },
            !1
          );
        }
