...
!(function (t, e) {
  ...
  var i = (function () {
    ...
    t = o('<div className="note-editor note-frame panel panel-default"/>'),
    e = o(
      '<div className="note-toolbar panel-heading" role="toolbar"></div></div>'
    ),
    n = o('<div className="note-editing-area"/>'),
    r = o(
      '<textarea className="note-codable" role="textbox" aria-multiline="true"/>'
    ),
    s = o(
      '<div className="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>'
    ),
    a = o(
      [
    ...
    d = o('<div className="note-btn-group btn-group">'),
    u = o('<ul className="dropdown-menu" role="list">', function (t, i) {
    ...
    h = o(
      '<ul className="dropdown-menu note-check" role="list">',
      function (t, n) {
    ...
    p = o('<div className="note-color-palette"/>', function (t, e) {
      for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
        for (
          ...
          l.push(
            [
              '<button type="button" className="note-color-btn"',
        ...
        o.push('<div className="note-color-row">' + l.join('') + '</div>');
      }
      t.html(o.join('')),
        e.tooltip &&
    ...
    f = o(
      '<div className="modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
      function (t, e) {
        e.fade && t.addClass('fade'),
          ...
          t.html(
            [
              ...
              e.title
                ? '    <div className="modal-header">      <button type="button" className="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>      <h4 className="modal-title">' +
                  e.title +
                  '</h4>    </div>'
                : '',
              '    <div className="modal-body">' + e.body + '</div>',
              e.footer
                ? '    <div className="modal-footer">' + e.footer + '</div>'
                : '',
              '  </div>',
              '</div>',
            ].join('')
    ...
    m = o(
      [
        '<div className="note-popover popover in">',
        '  <div className="arrow"/>',
    ...
    g = o('<div className="checkbox"></div>', function (t, e) {
      t.html(
        [
          '<label' + (e.id ? ' for="' + e.id + '"' : '') + '>',
    ...
    b = {
      ...
      button: function (t, e) {
        return o(
          '<button type="button" className="note-btn btn btn-default btn-sm" role="button" tabindex="-1">',
          function (t, e) {
            e &&
              e.tooltip &&
              t
  ...
  var Vt = (function () {
    ...
    Xt = (function () {
      ...
      return (
        ...
        (t.prototype.initialize = function () {
          var t = this;
          (this.$placeholder = C('<div className="note-placeholder">')),
            this.$placeholder
              .on('click', function () {
                    ...
                    (o
                      ? [
                          ...
                          '  <div className="note-palette-title">' +
                            ...
                            '</div>',
                          '  <div>',
                          '    <button type="button" className="note-color-reset btn btn-light" data-event="backColor" data-value="inherit">',
                          this.lang.color.transparent,
                          '    </button>',
                          '  </div>',
                          '  <div className="note-holder" data-event="backColor"/>',
                          '  <div>',
                          '    <button type="button" className="note-color-select btn" data-event="openPalette" data-value="backColorPicker">',
                          this.lang.color.cpSelect,
                          '    </button>',
                          '    <input type="color" id="backColorPicker" className="note-btn note-color-select-btn" value="' +
                            this.options.colorButton.backColor +
                            '" data-event="backColorPalette">',
                          '  </div>',
                          '  <div className="note-holder-custom" id="backColorPalette" data-event="backColor"/>',
                          '</div>',
                        ].join('')
                      : '') +
                    (n
                      ? [
                          ...
                          '  <div className="note-palette-title">' +
                            ...
                            '</div>',
                          '  <div>',
                          '    <button type="button" className="note-color-reset btn btn-light" data-event="removeFormat" data-value="foreColor">',
                          this.lang.color.resetToDefault,
                          '    </button>',
                          '  </div>',
                          '  <div className="note-holder" data-event="foreColor"/>',
                          '  <div>',
                          '    <button type="button" className="note-color-select btn" data-event="openPalette" data-value="foreColorPicker">',
                          this.lang.color.cpSelect,
                          '    </button>',
                          '    <input type="color" id="foreColorPicker" className="note-btn note-color-select-btn" value="' +
                            this.options.colorButton.foreColor +
                            '" data-event="foreColorPalette">',
                          '  <div className="note-holder-custom" id="foreColorPalette" data-event="foreColor"/>',
                          '</div>',
                        ].join('')
                      : ''),
                  callback: function (o) {
                ...
                n.ui
                  .buttonGroup([
                    n.button({
                      className: 'dropdown-toggle',
                      contents: n.ui.dropdownButtonContents(
                        '<span className="note-current-fontname"/>',
                        n.options
                      ),
              ...
              return n.ui
                .buttonGroup([
                  n.button({
                    className: 'dropdown-toggle',
                    contents: n.ui.dropdownButtonContents(
                      '<span className="note-current-fontsize"/>',
                      n.options
                    ),
                  ...
                  [
                    ...
                    n.ui.dropdown({
                      ...
                      items: [
                        ...
                        '  <div className="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"/>',
          ...
          var t = this.options.dialogsInBody ? this.$body : this.$editor,
            e = [
              ...
              '<label className="note-form-label">' +
                ...
                '</label>',
              '<input className="note-link-text form-control note-form-control note-input" type="text" />',
              '</div>',
              '<div className="form-group note-form-group">',
              '<label className="note-form-label">' +
                this.lang.link.url +
                '</label>',
              '<input className="note-link-url form-control note-form-control note-input" type="text" value="http://" />',
              '</div>',
            ...
            o =
              '<input type="button" href="#" className="btn btn-primary note-btn note-btn-primary note-link-btn" value="' +
        ...
        (t.prototype.initialize = function () {
          ...
          var i = [
              ...
              '<label className="note-form-label">' +
                ...
                '</label>',
              '<input className="note-image-input form-control-file note-form-control note-input" ',
              ...
              '<label className="note-form-label">' +
                this.lang.image.url +
                '</label>',
              '<input className="note-image-url form-control note-form-control note-input ',
              ' col-md-12" type="text" />',
              '</div>',
            ].join(''),
            r =
              '<input type="button" href="#" className="btn btn-primary note-btn note-btn-primary note-image-btn" value="' +
          ...
          var t = this.options.dialogsInBody ? this.$body : this.$editor,
            e = [
              ...
              '<label className="note-form-label">' +
                ...
                '</small></label>',
              '<input className="note-video-url form-control note-form-control note-input" type="text" />',
              '</div>',
            ].join(''),
            o =
              '<input type="button" href="#" className="btn btn-primary note-btn note-btn-primary note-video-btn" value="' +
      ...
      return (
        ...
        (t.prototype.createShortcutList = function () {
          ...
          return Object.keys(i)
            .map(function (t) {
              var e = i[t],
                o = C('<div><div className="help-list-item"/></div>');
              return (
                o
                  .append(
      ...
      return (
        ...
        (t.prototype.createItemTemplates = function (n, t) {
          ...
          return t.map(function (t, e) {
            var o = C('<div className="note-hint-item"/>');
            return (
        ...
        (t.prototype.createGroup = function (e, t) {
          var o = this,
            n = C(
              '<div className="note-hint-group note-hint-group-' + e + '"/>'
            );
          return (
