      ...
      <div className="cui__topbar">
        ...
        <div className="mr-auto">
          ...
          <div className="cui__topbar__livesearch">
            <button className="cui__topbar__livesearch__close" type="button">
        ...
        <div className=" mb-0 mr-auto d-xl-block d-none">
          ...
          >
            ...
            <span className="dropdown-toggle-text">Service Reports</span>
          </Link>
        </div>
        ...
        <div className=" mb-0 mr-auto d-xl-block d-none">
          ...
          >
            <i className="dropdown-toggle-icon fe fe-database"></i>
            <span className="dropdown-toggle-text">Payment Method</span>
          </Link>
        </div>
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="mb-3">
                          <div className="d-flex align-items-baseline">
                            ...
                            <span className="kit__l2__span">15 min ago</span>
                          </div>
                          <p className="kit__l2__content text-muted">
                        ...
                        <li className="mb-3">
                          <div className="d-flex align-items-baseline">
                            ...
                            <span className="kit__l2__span">5 Hours ago</span>
                          </div>
                          <p className="kit__l2__content text-muted">
