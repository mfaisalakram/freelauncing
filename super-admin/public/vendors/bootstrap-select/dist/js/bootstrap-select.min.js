  ...
  !(function (z) {
    ...
    var I,
      ...
      E =
        ...
        function (e) {
          return (
            (e = null === e ? '' : '' + e), y.test(e) ? e.replace(S, x) : e
          );
        }),
      C = {
        32: ' ',
        ...
        if (e.is('select')) {
          ...
          if (t) {
            ...
            (r.template = z.extend(
              ...
              e.data('selectpicker', (t = new J(this, r)));
          }
          'string' === typeof c &&
    ...
    (J.VERSION = '1.13.10'),
      (J.DEFAULTS = {
        ...
        tickIcon: j.TICKICON,
        showTick: !1,
        template: { caret: '<span className="caret"></span>' },
        maxOptions: !1,
        mobile: !1,
        selectOnTab: !1,
      ...
      (J.prototype = {
        ...
        createDropdown: function () {
          ...
          return (
            ...
            this.options.liveSearch &&
              (r =
                '<div className="bs-searchbox"><input type="text" className="form-control" autocomplete="off"' +
            ...
            this.multiple &&
              ...
              (l =
                '<div className="bs-actionsbox"><div className="btn-group btn-group-sm btn-block"><button type="button" className="actions-btn bs-select-all btn ' +
                j.BUTTONCLASS +
                '">' +
                this.options.selectAllText +
                '</button><button type="button" className="actions-btn bs-deselect-all btn ' +
                j.BUTTONCLASS +
                '">' +
            ...
            this.multiple &&
              ...
              (a =
                '<div className="bs-donebutton"><div className="btn-group btn-block"><button type="button" className="btn btn-sm ' +
                j.BUTTONCLASS +
                '">' +
            ...
            (n =
              ...
              this.selectId +
              '" aria-haspopup="listbox" aria-expanded="false"><div className="filter-option"><div className="filter-option-inner"><div className="filter-option-inner-inner"></div></div> </div>' +
              ('4' === M.major
                ? ''
          ...
          function l(e, t) {
            ...
            (D.selectpicker.view.scrollTop = e),
              !0 === m &&
                ...
                D.$menu[0].offsetWidth > D.sizeInfo.totalMenuWidth &&
                ((D.sizeInfo.menuWidth = D.$menu[0].offsetWidth),
                (D.sizeInfo.totalMenuWidth =
                  D.sizeInfo.menuWidth + D.sizeInfo.scrollBarWidth),
                D.$menu.css('min-width', D.sizeInfo.menuWidth)),
              (i = Math.ceil(
            ...
            for (var v = 0; v < s; v++) {
              ...
              void 0 === r &&
                e <=
                  D.selectpicker.current.data[g - 1].position -
            ...
            if (
              ...
              (t || a) &&
                ...
                (A || (!1 === m && t)) &&
                  ((d = c),
                  (h = D.selectpicker.view.visibleElements),
                  (f = !(
                    d.length === h.length &&
                ...
                D.options.sanitize &&
                  ...
                  (C =
                    D.selectpicker.current.data[
                      v + D.selectpicker.view.position0
                    ]) &&
                  C.content &&
                  !C.sanitized &&
              ...
              D.options.sanitize &&
                y.length &&
                P(y, D.options.whiteList, D.options.sanitizeFn),
                (I.firstChild.style.marginBottom =
                  !0 === m
                    ? ((b =
                      ...
                      (w =
                        D.selectpicker.view.position1 > p - 1
                          ? 0
                          : D.selectpicker.current.data[p - 1].position -
                            D.selectpicker.current.data[
                              D.selectpicker.view.position1 - 1
                            ].position),
                      (I.firstChild.style.marginTop = b + 'px'),
                      w + 'px')
                    : (I.firstChild.style.marginTop = 0)),
        ...
        createLi: function () {
          ...
          function w(e) {
            ...
            (t && 'divider' === t.type && (t.optID || e.optID)) ||
              (((e = e || {}).type = 'divider'),
              v.push(q(!1, j.DIVIDER, e.optID ? e.optID + 'div' : void 0)),
              g.push(e));
          }
          function I(e, t) {
            if (
          ...
          function i(e, t) {
            ...
            if (o.length) {
              ...
              b++, s && w({ optID: b });
              var d = Z(a);
              v.push(q(d, 'dropdown-header' + c, b)),
                g.push({
                  display: a.label,
                  subtext: a.subtext,
                  type: 'optgroup-label',
        ...
        render: function () {
          ...
          var e,
            ...
            d = !1;
          if (
            (r.classList.toggle('bs-placeholder', i.multiple ? !o : !O(s, n)),
            this.tabIndex(),
            'static' === this.options.selectedTextFormat)
          )
            c = Y({ text: this.options.title }, !0);
          else if (
            ((e =
              this.multiple &&
            ...
            for (var h = 0; h < o && h < 50; h++) {
              ...
              this.multiple && 0 < h && c.appendChild(a.cloneNode(!1)),
                p.title
                  ...
                  ? ((u.content = f.content.toString()), (d = !0))
                  : (i.options.showIcon &&
                      ((u.icon = f.icon), (u.iconBase = this.options.iconBase)),
                    i.options.showSubtext &&
                      !i.multiple &&
                      f.subtext &&
                      (u.subtext = ' ' + f.subtext),
                    (u.text = p.textContent.trim())),
                c.appendChild(Y(u, !0));
            }
          ...
          if (
            ...
            this.options.sanitize &&
              d &&
              P([c], i.options.whiteList, i.options.sanitizeFn),
            (l.innerHTML = ''),
            l.appendChild(c),
            M.major < 4 &&
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var v,
              ...
              C = {
                vert:
                  A(y ? y.paddingTop : E.css('paddingTop')) +
                  A(y ? y.paddingBottom : E.css('paddingBottom')) +
                  A(y ? y.borderTopWidth : E.css('borderTopWidth')) +
                  A(y ? y.borderBottomWidth : E.css('borderBottomWidth')),
                horiz:
                  A(y ? y.paddingLeft : E.css('paddingLeft')) +
                  A(y ? y.paddingRight : E.css('paddingRight')) +
                  A(y ? y.borderLeftWidth : E.css('borderLeftWidth')) +
                  A(y ? y.borderRightWidth : E.css('borderRightWidth')),
              },
              O = {
                vert:
                  C.vert +
                  A(y ? y.marginTop : E.css('marginTop')) +
                  A(y ? y.marginBottom : E.css('marginBottom')) +
                  2,
                horiz:
                  C.horiz +
                  A(y ? y.marginLeft : E.css('marginLeft')) +
                  A(y ? y.marginRight : E.css('marginRight')) +
                  2,
              };
          ...
          this.$button.on('click.bs.dropdown.data-api', function () {
            r.isDisabled() ||
              ...
              r.$bsContainer
                ...
                .toggleClass(j.SHOW, !r.$button.hasClass(j.SHOW))
                .append(r.$menu));
          }),
            z(window)
              .off(
            ...
            this.$menuInner.on('click', 'li a', function (e, t) {
              ...
              if (
                (C.multiple &&
                  ...
                  e.stopPropagation(),
                e.preventDefault(),
                !C.isDisabled() && !i.parent().hasClass(j.DISABLED))
              ) {
                  ...
                  if (
                    ...
                    if ((g && w) || (b && I))
                      if (g && 1 === g) {
                        ...
                        $[2] &&
                          ((y = y.replace('{var}', $[2][1 < g ? 0 : 1])),
                          (S = S.replace('{var}', $[2][1 < b ? 0 : 1]))),
                          u.prop('selected', !1),
                          C.$menu.append(E),
                          g &&
                            w &&
                            ...
                            (d = !1),
                            C.$element.trigger('maxReached' + U)),
                          b &&
                            I &&
                            (E.append(z('<div>' + S + '</div>')),
                            (d = !1),
                            C.$element.trigger('maxReachedGrp' + U)),
                          setTimeout(function () {
                            C.setSelected(r, !1);
                          }, 10),
                          E.delay(750).fadeOut(300, function () {
                            z(this).remove();
                          });
                      }
                  }
                } else
                  (c.selected = !1), (p.selected = !0), C.setSelected(r, !0);
        ...
        val: function (e) {
          ...
          if (
            ((T = [null, null, i]),
            this.$element.val(e).trigger('changed' + U, T),
