...
!(function (a, b) {
  ...
  function g(b, c) {
    ...
    e.removeData('loaded').removeData('mode').removeData('url'),
      ...
      b
        ...
        .empty();
    var f = a(
        '<{0} className="{1}"></{0}>'.format(b.get(0).tagName, b.attr('class'))
      ),
      g = b._id();
    return (
      null != g && '' !== g && f._id(g),
  ...
  function L(a, b, c) {
    if (b.enablePagination) {
      var d =
          '<{0} className="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
  ...
  var $ = (a.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 }),
    ...
    cb = (a.fn.steps.defaults = {
      ...
      loadingTemplate: '<span className="spinner"></span> #text#',
      autoFocus: !1,
      enableAllSteps: !1,
