        ...
        r = (function () {
          ...
          return (
            ...
            (r.prototype.viewDate = function (a) {
              ...
              if (
                !('string' === typeof a || b.isMoment(a) || a instanceof Date)
              )
                throw new TypeError(
            ...
            for (
              b
                ...
                i +=
                  d.year() - 10 < 0
                    ? '<span>&nbsp;</span>'
                    : '<span data-action="selectDecade" className="decade old" data-selection="' +
                      (d.year() + 6) +
                      '">' +
                      (d.year() - 10) +
                      '</span>';
              ...
              (h = d.year() + 11),
                ...
                (i +=
                  '<span data-action="selectDecade" className="decade' +
                ...
                if (
                  (0 === d.weekday() &&
                    ...
                    this._options.calendarWeeks &&
                      f.append('<td className="cw">' + d.week() + '</td>'),
                    c.push(f)),
                  (g = ''),
          ...
          (k.prototype._fillHours = function () {
            ...
            for (
              ...
              b.hour() % 4 === 0 && ((d = e('<tr>')), c.push(d)),
                d.append(
                  '<td data-action="selectHour" className="hour' +
          ...
          (k.prototype._fillMinutes = function () {
            for (
              ...
              b.minute() % (4 * d) === 0 && ((f = e('<tr>')), c.push(f)),
                f.append(
                  '<td data-action="selectMinute" className="minute' +
          ...
          (k.prototype._fillSeconds = function () {
            for (
              ...
              b.second() % 20 === 0 && ((d = e('<tr>')), c.push(d)),
                d.append(
                  '<td data-action="selectSecond" className="second' +
